    ...
    Route::middleware('database.selected')->group(function () {
        ...
        Route::prefix('admin')
            ...
            Route::prefix('inventory')
                ...
                Route::get('/stock-adjustment/data', [
                    StockAdjusmentController::class,
                    'getData',
                ])->name('stock-adjustment.data');
                Route::post('/stock-adjustment/{adjustment}/approve', [
                    StockAdjusmentController::class,
                    'approve',
                ])->name('stock-adjustment.approve');
                Route::post('/stock-adjustment/{adjustment}/reject', [
                    StockAdjusmentController::class,
                    'reject',
                ])->name('stock-adjustment.reject');
                Route::get('/stock-adjustment/pending-approvals', [
                    StockAdjusmentController::class,
                    'pendingApprovals',
                ])->name('stock-adjustment.pending-approvals');
