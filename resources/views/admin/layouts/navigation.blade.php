<div class="flex flex-col h-full text-gray-800 bg-white">
    <div class="h-[64px] border-b flex items-center flex-shrink-0" :class="sidebarOpen ? 'px-4' : 'justify-center'">
        <a href="{{ route('admin.inbound.dashboard') }}" class="flex items-center space-x-3">
    ...
    <nav class="flex-1 px-3 py-4 space-y-2">
        ...
        <a href="{{ route('admin.inbound.dashboard') }}" class="{{ $linkClasses }} {{ request()->routeIs('admin.inbound.dashboard') ? $activeClasses : $inactiveClasses }}" :class="!sidebarOpen && 'justify-center'">
