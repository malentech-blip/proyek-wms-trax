<x-app-layout>
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="p-6 border-b">
            <h3 class="text-lg font-semibold text-gray-800">Filter Work In Progress</h3>
            ...
            <form method="GET">
                <div class="mt-4 grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    <div>
                        ...
                        <input type="date" name="start_date" id="start_date" onblur="this.form.submit()"
                    ...
                    <div class="md:col-span-2">
                        <label for="search" class="text-sm font-medium text-gray-700">Cari No. Work In Progress</label>
                ...
                <tbody class="divide-y">
                    @forelse ($wipRecords as $wip)
                        <tr class="cursor-pointer"
                            onclick="window.location='{{ route('admin.production.wip.detail', $wip->mr_id) }}'"">
