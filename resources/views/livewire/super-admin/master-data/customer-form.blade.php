    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg" @click.away="$wire.set('showModal', false)">
            <form wire:submit.prevent="save" class="w-full">
                <div class="p-6 border-b"><h3 class="text-lg font-semibold">Tambah Customer Baru</h3></div>
                ...
                <div class="p-4 bg-gray-50 flex justify-end space-x-2">
                    ...
                    <button type="submit" class="bg-blue-600 text-white rounded-lg px-4 py-2">Simpan Customer</button>
                </div>
            </form>
        </div>
    </div>
